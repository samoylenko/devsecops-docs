...
| Code editor ([IDE](https://en.wikipedia.org/wiki/Integrated_development_environment)) of your choice | [Visual Studio Code](https://code.visualstudio.com/)                                                                 | Code Editor is a matter of preference. If you need a recommendation, VS Code is probably the most popular free IDE                                                                                                                                                                                                                                     |
...
| HTTP Protocol       | ([link](https://developer.mozilla.org/en-US/docs/Web/HTTP/Overview))                   | N/A                                                          | Protocol used for communication between two computer systems. Essential for modern software development                                                                                      |
